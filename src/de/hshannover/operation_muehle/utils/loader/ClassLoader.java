 ...
 * 
 * @deprecated ClassLoader exists in java.lang package. use StrategyLoader only.
 * 
 */
public class ClassLoader {
	 ...
	 * 
	 * @param searchPath
	 *            directory to seach for JARs
	 * @throws IOException
	 *             If there's an error reading one of the JARs
	 * @throws IllegalArgumentException
	 *             if searchPath is not a directory
	 */
	public ClassLoader(String searchPath) throws IOException {
